...
public final class DisplayLeakConnectorView extends View {
    ...
    static {
        iconPaint.setColor(ExViewUi.LIGHT_GREY);
        rootPaint.setColor(ExViewUi.ROOT_COLOR);
        leakPaint.setColor(ExViewUi.LEAK_COLOR);
        clearPaint.setColor(Color.TRANSPARENT);
        clearPaint.setXfermode(ExViewUi.CLEAR_XFER_MODE);
    }
    ...
    @SuppressWarnings("SuspiciousNameCombination") @Override protected void onDraw(Canvas canvas) {
        ...
        if (cache == null) {
            ...
            float strokeSize = ExViewUi.dpToPixel(4f, getResources());
